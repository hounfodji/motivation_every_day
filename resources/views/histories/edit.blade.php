    ...
    <x-posts-card>
        ...
        <form action="{{ route('histories.update', $history->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div>
                ...
                <x-text-input id="title" class="block mt-1 w-full" type="text" name="title" :value="old('title', $history->title)" required autofocus />
            ...
            <div class="mt-4">
                ...
                <x-textarea class="block mt-1 w-full" id="detail" name="detail">{{ old('detail', $history->detail) }}</x-textarea>
            ...
            <div class="mt-4">
                ...
                <x-textarea class="block mt-1 w-full" id="author" name="author">{{ old('author', $history->author) }}</x-textarea>
