<x-app-layout>
    ...
    <div class="container mx-auto ">
        <div class="flex justify-between">
            <div class="w-1/2 ... ">
                <!-- Colonne de gauche pour les citations -->
            ...
            <div class="w-1/2 ... ">
                <!-- Colonne de droite pour les histoires -->
                <div class="w-1/2">
                                    ...
                                    <table>
                                        ...
                                        <tbody class="bg-white">
                                            @foreach ($histories as $history)
                                                <tr class="whitespace-nowrap">
                                                    <td class="px-4 py-4 text-sm text-gray-500">{{ $history->id }}</td>
                                                    <td class="px-4 py-4">{{ $history->title }}</td>
                                                    <td class="px-4 py-4">{{ $history->author }}</td>
                                                    {{-- <td class="px-4 py-4">@if ($history->state) {{ __('Done') }} @else {{ __('To do') }} @endif</td> --}}
                                                    <td class="px-4 py-4">
                                                        @if ($history->image)
